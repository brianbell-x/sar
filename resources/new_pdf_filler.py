...
def fill_sar_pdf(data: Dict[str, Any], template_path: str, output_path: str) -> None:
    ...
    Args:
        ...
        template_path: Path to the modified PDF template (e.g., 6710-06ive.pdf).
...
def create_test_dataive() -> Dict:
    ...
    return {
        ...
        "activity_other": True,
        "activity_otherion": "Unusual pattern of international wires",
...
if __name__ == "__main__":
    ...
    #    Example: python resources/update_field_names.py --input resources/6710-06.pdf --output resources/6710-06ive.pdf
    # 2. Make sure the output path for the filled PDF exists or can be created.

    descriptive_template = "resources/6710-06.pdf" # Path to the PDF generated by update_field_names.py
    test_output_path = "output/sar_filled_test.pdf" # Output path for this test

    import os
    if not os.path.exists(descriptive_template):
        print(f"ERROR: Descriptive template PDF not found at '{descriptive_template}'.")
        print("Please run 'python resources/update_field_names.py --input resources/6710-06.pdf --output resources/6710-06ive.pdf' first.")
    else:
        print("Creating test data with descriptive names...")
        test_data = create_test_dataive()
